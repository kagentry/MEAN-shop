...
module.exports = function (wagner) {
  ...
  // This route will take all the products in the user's cart
  // and sum up their approximate price USD field
  // to get the total price of all products in the user's car
  // in US dollars.
  /* User API */
      ...
      req.user.populate({
        ...
        Stripe.charges.create({
          ...
          function (err, charge) {
            ...
            // and if there are no errors, you empty out the user's carts
            // and save the user.
            req.user.data.cart = [];
